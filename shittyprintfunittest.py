...
UNITTEST = {
    # nom du fichier : [format , value1, value2, ... ],
     "simple_test": ["simple"],
    "int_test": ["[%.0d] [%-10d] [%.10d] [%-10.5d] [%-10.15d] [%010d] [%010.5d] [%010.15d]", 0, 2147483647, 2147483647, 2147483647, 2147483647, 2147483647, 2147483647, 2147483647],
    "int_neg_test": ["[%.0d] [%-10d] [%.10d] [%-10.5d] [%-10.15d] [%010d] [%010.5d] [%010.15d]", -12, -12, -12, -12, -12, -12, -12, -12],
