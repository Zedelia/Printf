...
UNITTEST = {
	...
	"test_int_zero_65": ["%---------45.*d]", 0, 0],
	"test_int_zero_66": ["%00000000045.*d]", 0, 0],
	...
	"test_int_pos_65": ["%--------*.*d]", -5, 5, 2147483647],
	"test_int_pos_66": ["%00000000*.*d]", -5, 5, 2147483647],
	...
	"test_int_neg_65": ["%-------*.*d]", -5, 5, -2147483647],
	"test_int_neg_65": ["%0000000*.*d]", -5, 5, -2147483647],
    "test_u_zero": ["%u]", 0],
	...
	"test_u_neg_65": ["%----------*.*u]", -56, 4, -2147483647],
	"test_u_neg_66": ["%0000000000*.*u]", -56, 4, -2147483647],
	...
	"test_u_pos_65": ["%----------*.*u]", -6, 6, 2147483647],
	"test_u_pos_66": ["%0000000000*.*u]", -6, 6, 2147483647],
    "test_x_zero": ["%u]", 0],
	...
	"test_x_neg_65": ["%---------*.*x]", -4, 4, -2147483647],
	"test_x_neg_66": ["%000000000*.*x]", -4, 4, -2147483647],
	...
	"test_x_pos_65": ["%----------*.*x]", -5, 5, 2147483647],
	"test_x_pos_66": ["%0000000000*.*x]", -5, 5, 2147483647],
	"test_bigX_zero": ["%X]", 0],
	...
	"test_bigX_neg_65": ["%--------*.*X]", -25, 5, -2147483647],
	"test_bigX_neg_66": ["%00000000*.*X]", -25, 5, -2147483647],
	...
	"test_bigX_pos_64": ["%-*.*X]", 0, 0, 2147483647],
	"test_bigX_pos_65": ["%-----------*.*X]", -5, 5, 2147483647],
	"test_bigX_pos_66": ["%00000000000*.*X]", -5, 5, 2147483647],
	"test_char_c_00": ["%c]", 0],
	"test_char_c_01": ["%c]", 'c'],
	...
	"test_percent_65": ["%-----------*.*%]", -200, 100],
	"test_percent_66": ["%00000000*.*%]", -200, 100],
