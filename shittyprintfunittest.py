...
UNITTEST = {
	...
	"test_all_mixedup_03": ["qwerty [%1.2*s], [%087c], [%21.62d], [%087u],  [%-*x], [%-1.*d],", 3, "qwerty", 'X', 12, 0, -6, 14, 456, 45],
	"test_all_mixedup_03": ["%% qwerty [%1.*s], [%87c], [%*.62d], [%% %u],  [%-*x], [%-198.*d],", 3, "qwerty", 'X', 5, 12, 45678965, -6, 14, 456, 45],
}
