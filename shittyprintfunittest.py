...
UNITTEST = {
	...
	# "test_int_neg_23": ["[%.15d]", -2147483647],
	...
	"test_x_neg_04": ["[%15x]", -2147483647],
	"test_x_neg_05": ["[%015.0x]", -2147483647],
	"test_x_neg_06": ["[%15.0x]", -2147483647],
	"test_x_neg_07": ["[%-15.0x]", -2147483647],
    "test_x_neg_08": ["[%-5.0x]", -2147483647],
	"test_x_neg_09": ["[%.5x]", -2147483647],
	"test_x_neg_10": ["[%-5.5x]", -2147483647],
	"test_x_neg_11": ["[%0.15x]", -2147483647],
	"test_x_neg_12": ["[%.15x]", -2147483647],
	"test_x_neg_13": ["[%-5.15x]", -2147483647],
	"test_x_neg_14": ["[%015.15x]", -2147483647],
    "test_x_neg_15": ["[%15.15x]", -2147483647],
	"test_x_neg_16": ["[%-15.15x]", -2147483647],
	...
	"test_x_neg_22": ["[%.15x]", -2147483647],
    "test_x_pos_01": ["[%0x]", 2147483647],
	"test_x_pos_02": ["[%0.0x]", 2147483647],
	"test_x_pos_03": ["[%.0x]", 2147483647],
	"test_x_pos_04": ["[%15x]", 2147483647],
	"test_x_pos_05": ["[%015.0x]", 2147483647],
	"test_x_pos_06": ["[%15.0x]", 2147483647],
	"test_x_pos_07": ["[%-15.0x]", 2147483647],
    "test_x_pos_08": ["[%-5.0x]", 2147483647],
	"test_x_pos_09": ["[%.5x]", 2147483647],
	"test_x_pos_10": ["[%-5.5x]", 2147483647],
	"test_x_pos_11": ["[%0.15x]", 2147483647],
	"test_x_pos_12": ["[%.15x]", 2147483647],
	"test_x_pos_13": ["[%-5.15x]", 2147483647],
	"test_x_pos_14": ["[%015.15x]", 2147483647],
    "test_x_pos_15": ["[%15.15x]", 2147483647],
	"test_x_pos_16": ["[%-15.15x]", 2147483647],
	...
	"test_percent_03": ["[%.0%]"],
	"test_percent_04": ["[%15%]"],
	"test_percent_05": ["[%015.0%]"],
	"test_percent_06": ["[%15.0%]"],
	"test_percent_07": ["[%-15.0%]"],
    "test_percent_08": ["[%-5.0%]"],
	"test_percent_09": ["[%.5%]"],
	"test_percent_10": ["[%-5.5%]"],
	"test_percent_11": ["[%0.15%]"],
	"test_percent_12": ["[%.15%]"],
	"test_percent_13": ["[%-5.15%]"],
	"test_percent_14": ["[%015.15%]"],
    "test_percent_15": ["[%15.15%]"],
	"test_percent_16": ["[%-15.15%]"],
	"test_percent_17": ["[%5%]"],
	...
	"test_percent_21": ["[%5.5%]"],
	"test_percent_22": ["[%.15%]"],
	"test_percent_23": ["[%-015.15%]"],
	"test_percent_24": ["[%%]"],
	"test_all_mixed_01": ["[%-12d], [%12.5s], [%-4c], [%21.6d], [%0u], [%-5d]", 12, "qwerty", 'X', 12, 45678965, -6],
}
